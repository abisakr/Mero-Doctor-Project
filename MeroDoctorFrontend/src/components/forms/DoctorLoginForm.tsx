...
import type { DoctorLoginRequest } from "../../types/auth";
import { DoctorLoginUser } from "../../services/authService";
...
function LoginForm() {
  const {
    ...
    handleSubmit,
    formState: { errors }
  } = useForm<DoctorLoginRequest>();

const navigate = useNavigate();
  const onSubmit = async (data: DoctorLoginRequest) => {
try {
    console.log(data);
   const response = await DoctorLoginUser(data);
